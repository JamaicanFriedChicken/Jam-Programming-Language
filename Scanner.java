...
import static com.craftinginterpreters.jam.TokenType.*;
...
private void scanToken() {
    ...
    switch(c) {
        ...
        // to handle other characters such as #@^
        default:
            if (isDigit(c)) {
                number();
            } else if (isAlpha(c)) {
                ...
                Jam.error(line, "Unexpected character.");
            }
            break;
    }
}
...
private void number () {
    ...
    // Look for a fraction(decimal places) part.
